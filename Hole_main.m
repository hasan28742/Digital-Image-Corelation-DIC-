%Digital Image corelation(DIC) project
...
R = imread('referenceimage.tif');%R=reference image=referenceimage.tif
C = imread('deformedimage.tif');%C=current image=deformedimage.tif
...
for i = 1:5% the second value might be equal to number of excluded area
